    ...
    <div class="container text-center my-5">
        <div class="row">
            <div class="col-12 ">
             ...
             <div class="container">
               <iframe id="iframe" class="m-5" width="560" height="315" src="https://www.youtube.com/embed/<?php echo $detail_Film['b_annonce'];?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="col-4 text-center">
                ...
                <form method="post" class=" p-2 mb-1" id="avis">
                    <h2 class="text-center text-warning">Avis</h2>
                    ...
                    <div class="text-center mt-3 px-3">
                        <button type="submit" class="btn btn-success btn-rounded">Envoyer</button>
                ...
                <div class="col-6">
                    <?php foreach($all_messages as $message):?>
			            ...
			            <div class="col-6">
				        <h4 class="username text-warning">
					<?=$message['name'];?>
				</h4>
